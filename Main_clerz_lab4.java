...
public class Main {
    public static void main(String[] args) {
      ...
      System.out.println("\n\nBubble sort results ----------------------------------------------");
      ArrayList<Integer> listForBubbleSort = new ArrayList<>(integerList);
      long startTimeBubble = System.nanoTime();
      ArrayList<Integer> bubbleSortedList = Lab4.bubbleSort(integerList);
      long endTimeBubble = System.nanoTime();
      Lab4.outputList(bubbleSortedList);
      long durationBubble = (endTimeBubble - startTimeBubble) / 1000000;
      System.out.println("\nTime taken for Bubble Sort: " + durationBubble + " milliseconds");


      System.out.println("\n\nInsertion sort results -------------------------------------------");
      ArrayList<Integer> listForInsertionSort = new ArrayList<>(integerList);
      ...
      System.out.println("\nTime taken for Insertion Sort: " + durationInsertion + " milliseconds");
    }
}
